...
pub struct DefinitionElement {
    ...
    pub shade: bool,
    #[serde(default, skip_serializing_if = "HashMap::is_empty")]
    pub faces: HashMap<Direction, ElementFace>,
}
...
impl DefinitionElement {
    ...
    pub fn positions_from(&self, direction: Direction) -> [[f32; 3]; 4] {
        ...
        match direction {
            Direction::Up => [[x1, y2, z1], [x2, y2, z1], [x2, y2, z2], [x1, y2, z2]],
            Direction::Down => [[x1, y1, z2], [x2, y1, z2], [x2, y1, z1], [x1, y1, z1]],
            Direction::North => [[x1, y1, z1], [x2, y1, z1], [x2, y2, z1], [x1, y2, z1]],
            Direction::South => [[x2, y1, z2], [x1, y1, z2], [x1, y2, z2], [x2, y2, z2]],
            Direction::West => [[x1, y1, z2], [x1, y1, z1], [x1, y2, z1], [x1, y2, z2]],
            Direction::East => [[x2, y1, z1], [x2, y1, z2], [x2, y2, z2], [x2, y2, z1]],
        }
        .map(|[x, y, z]| [x / 16f32, y / 16f32, z / 16f32])
    }

    /// Returns the UVs of the element face.
    pub fn uvs_from(&self, direction: Direction) -> [[f32; 2]; 4] {
        let [x1, y1, z1] = self.from;
        let [x2, y2, z2] = self.to;
        match direction {
            Direction::Up | Direction::Down => [[x1, z1], [x2, z1], [x2, z2], [x1, z2]],
            Direction::North | Direction::South => [[x2, y1], [x1, y1], [x1, y2], [x2, y2]],
            Direction::West | Direction::East => [[z2, y1], [z1, y1], [z1, y2], [z2, y2]],
        }
