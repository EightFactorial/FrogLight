...
froglight_macros::entity_attribute_properties! {
    ...
    CameraDistance => { properties: { ident: "minecraft:camera_distance", key: "minecraft.attribute.name.camera_distance", default: 4f64, range: 0f64..=32f64 } },
    ...
    WaypointTransmitRange => { properties: { ident: "minecraft:waypoint_transmit_range", key: "minecraft.attribute.name.waypoint_transmit_range", default: 0f64, range: 0f64..=60000000f64 } },
    WaypointReceiveRange => { properties: { ident: "minecraft:waypoint_receive_range", key: "minecraft.attribute.name.waypoint_receive_range", default: 0f64, range: 0f64..=60000000f64 } },
}
