...
froglight_macros::impl_generated_entities! {
    AcaciaBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    AcaciaChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    BambooChestRaft => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    BambooRaft => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    BirchBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    BirchChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    CherryBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    CherryChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    Creaking => { HostileMobs, HostileEntity, EntitySize(0.9f32,2.7f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, LivingEntityFlags, Health, EffectParticles, EffectAmbience, MobFlags, CanMove, IsActive },
    CreakingTransient => { HostileMobs, HostileEntity, EntitySize(0.9f32,2.7f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, LivingEntityFlags, Health, EffectParticles, EffectAmbience, MobFlags, CanMove, IsActive },
    ...
    DarkOakBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    DarkOakChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    JungleBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    JungleChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    MangroveBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    MangroveChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    OakBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    OakChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    PaleOakBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    PaleOakChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    ...
    SpruceBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
    SpruceChestBoat => { Vehicles, OtherEntity, EntitySize(1.375f32,0.5625f32), SharedFlags, AirSupply, Silent, NoGravity, TicksFrozen, Hurt, Damage, PaddleLeft, PaddleRight, BubbleTime },
