...
fn proto_write_f32() {
    ...
    assert!(0f32.fg_write(&mut buf).is_ok());
    assert_eq!(buf, vec![0, 0, 0, 0]);
    buf.clear();

    assert!(1.0f32.fg_write(&mut buf).is_ok());
    assert_eq!(buf, vec![63, 128, 0, 0]);
    buf.clear();

    assert!(1.5f32.fg_write(&mut buf).is_ok());
...
fn proto_write_f64() {
    ...
    assert!(0f64.fg_write(&mut buf).is_ok());
    assert_eq!(buf, vec![0, 0, 0, 0, 0, 0, 0, 0]);
    buf.clear();

    assert!(1.0f64.fg_write(&mut buf).is_ok());
    assert_eq!(buf, vec![63, 240, 0, 0, 0, 0, 0, 0]);
    buf.clear();

    assert!(1.5f64.fg_write(&mut buf).is_ok());
