...
pub struct IndexedLocalStorage<
    V: Downcast + ?Sized + 'static,
...
impl<V: Downcast + ?Sized + 'static, I: From<usize> + Into<usize> + Send + Sync>
    IndexedLocalStorage<V, I>
{
...
impl<V: Downcast + ?Sized + 'static, I: From<usize> + Into<usize>> Clone
