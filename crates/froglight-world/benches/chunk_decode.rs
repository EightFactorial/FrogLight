...
fn decode_chunk(
    ...
    Ok(Chunk::read_from_buffer(height, offset, &mut cursor)
    ...
    c.bench_function("chunk_1 256", |b| {
        b.iter(|| {
            decode_chunk(
                black_box(256),
                black_box(0),
                black_box(include_bytes!("data/chunk1_256.bin")),
            )
        });
    });
    c.bench_function("chunk_2 256", |b| {
        b.iter(|| {
            decode_chunk(
                black_box(256),
                black_box(0),
                black_box(include_bytes!("data/chunk2_256.bin")),
            )
        });
    });
    ...
    c.bench_function("chunk_1 384", |b| {
        b.iter(|| {
            decode_chunk(
                black_box(384),
                black_box(-64),
                black_box(include_bytes!("data/chunk1_384.bin")),
            )
        });
    });
    c.bench_function("chunk_2 384", |b| {
        b.iter(|| {
            decode_chunk(
                black_box(384),
                black_box(-64),
                black_box(include_bytes!("data/chunk2_384.bin")),
            )
        });
    });
}
