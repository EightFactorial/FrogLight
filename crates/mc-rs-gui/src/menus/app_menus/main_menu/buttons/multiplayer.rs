...
pub struct MultiplayerButtonComponent;

impl MenuComponent for MultiplayerButtonComponent {
    ...
    fn build(parent: Entity, world: &mut World) {
        ...
        world
            .spawn(TextBundle::from_section("Multiplayer", font_style.into()))
            .set_parent(background);
    }
}

impl MultiplayerButtonComponent {
    fn pressed(
