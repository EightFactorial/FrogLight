...
fn main() {
    ...
    // 213, 214, 215, 216, 217,                 446, 447, 448, 449, 450,
    // 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461,             ],
    //         );
    //         data.insert(ResourceKey::new("minecraft:rails"), vec![763, 761,
    // 762, 764]);         data.insert(
    ...
    //     tag_values.iter().map(|id|
    // ConvertId::<V1_21_0>::from_id(*id).unwrap()).collect(); println!(
    //     "
    // {keys:?}\n"
    // );
    ...
    // let tag_values =
    // tag_data.get("minecraft:enchantable/fire_aspect").unwrap(); let keys:
    // Vec<ItemKey> =     tag_values.iter().map(|id|
    // ConvertId::<V1_21_0>::from_id(*id).unwrap()).collect(); println!(
    //     "
    // {keys:?}\n"
    // );
