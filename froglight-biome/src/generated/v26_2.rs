//! Biome data for [`V26_2`](froglight_common::version::V26_2).
//! 
//! @generated
...
generate! {
    ...
    SulfurCaves => { ident: "minecraft:sulfur_caves", global: 55, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 3456905, precip: true, temp: 0.8f32, downfall: 0.4f32 },
        attr: { VisualSkyColor: "#78a7ff", VisualWaterFogColor: "#17543c" }
    },
    NetherWastes => { ident: "minecraft:nether_wastes", global: 56, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 2f32, downfall: 0f32 },
    ...
    WarpedForest => { ident: "minecraft:warped_forest", global: 57, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 2f32, downfall: 0f32 },
    ...
    CrimsonForest => { ident: "minecraft:crimson_forest", global: 58, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 2f32, downfall: 0f32 },
    ...
    SoulSandValley => { ident: "minecraft:soul_sand_valley", global: 59, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 2f32, downfall: 0f32 },
    ...
    BasaltDeltas => { ident: "minecraft:basalt_deltas", global: 60, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 2f32, downfall: 0f32 },
    ...
    TheEnd => { ident: "minecraft:the_end", global: 61, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 0.5f32, downfall: 0.5f32 },
        attr: { }
    },
    EndHighlands => { ident: "minecraft:end_highlands", global: 62, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 0.5f32, downfall: 0.5f32 },
        attr: { }
    },
    EndMidlands => { ident: "minecraft:end_midlands", global: 63, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 0.5f32, downfall: 0.5f32 },
        attr: { }
    },
    SmallEndIslands => { ident: "minecraft:small_end_islands", global: 64, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 0.5f32, downfall: 0.5f32 },
        attr: { }
    },
    EndBarrens => { ident: "minecraft:end_barrens", global: 65, prop: { foliage: 0, dry_foliage: 0, grass: 0, water: 4159204, precip: false, temp: 0.5f32, downfall: 0.5f32 },
        attr: { }
    }
}
