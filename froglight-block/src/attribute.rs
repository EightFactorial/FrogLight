//! The [`BlockAttribute`] and [`BlockAttributeBundle`] traits.
...
/// A bundle of block attributes.
pub trait BlockAttributeBundle: Sized + 'static {
...
impl<T0: BlockAttribute> BlockAttributeBundle for T0 {
    const SIZE: usize = 1;
    #[allow(
...
impl<T0: BlockAttributeBundle> BlockAttributeBundle for (T0,) {
    const SIZE: usize = 1;
...
macro_rules! implement {
    ...
    ($($T:ident),*) => {
        ...
        impl<$($T: BlockAttribute),*> BlockAttributeBundle for ($($T,)*) {
