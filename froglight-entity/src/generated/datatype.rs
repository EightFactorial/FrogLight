...
generate! {
    ...
    as_optional_block_pos => OptionalBlockPos(()),
    as_optional_block_state => OptionalBlockState(()),
    as_optional_component => OptionalComponent(Option<()>),
    as_optional_living_entity_reference => OptionalLivingEntityReference(()),
    as_optional_unsigned_int => OptionalUnsignedInt(()),
