...
generate! {
    ...
    datatypes: {
        ...
        ItemStack(()) = 7,
        BlockState(()) = 8,
        OptionalBlockState(Option<()>) = 9,
        Boolean(bool) = 10,
        Particle(()) = 11,
        Particles(()) = 12,
        Rotations(()) = 13,
        BlockPos(()) = 14,
        OptionalBlockPos(Option<()>) = 15,
        Direction(()) = 16,
        OptionalLivingEntityReference(Option<()>) = 17,
        OptionalGlobalPos(Option<()>) = 18,
        VillagerData(()) = 19,
        OptionalUnsignedInt(Option<VarInt>) = 20,
        Pose(()) = 21,
        CatVariant(()) = 22,
        CatSoundVariant(()) = 23,
        ChickenVariant(()) = 24,
        ChickenSoundVariant(()) = 25,
        CowVariant(()) = 26,
        CowSoundVariant(()) = 27,
        WolfVariant(()) = 28,
        WolfSoundVariant(()) = 29,
