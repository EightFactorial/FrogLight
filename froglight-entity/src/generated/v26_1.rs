...
generate! {
    ...
    datatypes: {
        Byte(u8) = 0,
        Int(i32) = 1,
        OptionalComponent(Option<()>) = 2,
        Boolean(bool) = 3,
        Pose(()) = 4,
        Float(f32) = 5,
        Particles(()) = 6,
        OptionalBlockPos(Option<()>) = 7,
        Particle(()) = 8,
        ArmadilloState(()) = 9,
        Rotations(()) = 10,
        Long(i64) = 11,
        ...
        Quaternion(()) = 13,
        BlockState(()) = 14,
        OptionalLivingEntityReference(Option<()>) = 15,
        CatVariant(()) = 16,
        CatSoundVariant(()) = 17,
        OptionalBlockState(Option<()>) = 18,
        ChickenVariant(()) = 19,
        ChickenSoundVariant(()) = 20,
        WeatheringCopperState(()) = 21,
        CopperGolemState(()) = 22,
        String(Cow<'static, str>) = 23,
        Component(()) = 24,
        CowVariant(()) = 25,
        CowSoundVariant(()) = 26,
        ItemStack(()) = 27,
        BlockPos(()) = 28,
        OptionalUnsignedInt(Option<u32>) = 29,
        FrogVariant(()) = 30,
        Direction(()) = 31,
        HumanoidArm(()) = 32,
        ResolvableProfile(()) = 33,
        PaintingVariant(()) = 34,
        PigVariant(()) = 35,
        PigSoundVariant(()) = 36,
        SnifferState(()) = 37,
