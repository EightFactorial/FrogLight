...
generate! {
    ...
    @block ChorusPlant,
    @block Cinnabar,
    @block CinnabarBrickSlab,
    @block CinnabarBrickStairs,
    @block CinnabarBrickWall,
    @block CinnabarBricks,
    @block CinnabarSlab,
    @block CinnabarStairs,
    @block CinnabarWall,
    @block Clay,
    ClayBall,
    Clock,
    ...
    @block PolishedSulfur,
    @block PolishedSulfurSlab,
    @block PolishedSulfurStairs,
    @block PolishedSulfurWall,
    @block PolishedTuff,
    ...
    @block SugarCane,
    @block Sulfur,
    @block SulfurBrickSlab,
    @block SulfurBrickStairs,
    @block SulfurBrickWall,
    @block SulfurBricks,
    SulfurCubeBucket,
    SulfurCubeSpawnEgg,
    @block SulfurSlab,
