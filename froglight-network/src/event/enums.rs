...
use froglight_packet::common::{
    ...
    entity_data::{AddEntityBundle, SetEntityBundle},
...
pub enum ClientboundPlayEvent {
    ...
    ChunkCacheRadius(),
    ChunkSectionUpdate(),
    ChunkWithLight(ChunkPos, RawChunkData, RawLightData),
    ClearDialog,
    ClearTitles(),
    CommandSuggestions(),
    Commands(),
    ...
    DiskSpaceWarning(),
    EntityEvent(),
    EntityPosition(EntityId, EntityPositionRotationData, bool),
    Explode(),
    ForgetChunk(ChunkPos),
    GameEvent(),
    GameRule(),
    GameTestHighlight(),
    GhostRecipe(),
    ...
    LevelEvent(),
    LevelParticles(),
    LightUpdate(ChunkPos, RawLightData),
    Login(PlayLoginContent),
    MapItemData(),
    MerchantOffers(),
    MountScreen(),
    MoveEntityPos(EntityPositionUpdateData),
    MoveEntityPosRot(EntityPositionUpdateData),
    MoveEntityRot(EntityPositionUpdateData),
    MoveMinecartTrack(),
    MoveVehicle(),
    OpenBook(),
    OpenScreen(),
    ...
    SetDefaultSpawn(),
    SetDisplayObjective(),
    SetEntityData(SetEntityBundle),
    SetEntityLink(),
    SetEntityMotion(EntityId, LpDVec3),
    SetEquipment(),
    SetExperience(),
    SetHealth(),
    SetHeldSlot(),
