//! @generated [`Config`](crate::version::Config) packets for v26.1

mod s2c_0x00_cookie_request;
pub use s2c_0x00_cookie_request::CookieRequestS2CPacket;

mod s2c_0x01_custom_payload;
pub use s2c_0x01_custom_payload::CustomPayloadS2CPacket;

mod s2c_0x02_disconnect;
pub use s2c_0x02_disconnect::DisconnectS2CPacket;
...
pub use c2s_0x02_custom_payload::CustomPayloadC2SPacket;
