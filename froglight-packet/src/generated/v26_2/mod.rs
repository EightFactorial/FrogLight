...
mod traits {
    ...
    impl PacketState<V26_2> for Handshake {
    ...
    impl PacketState<V26_2> for Status {
    ...
    impl PacketState<V26_2> for Login {
    ...
    impl PacketState<V26_2> for Config {
    ...
    impl PacketState<V26_2> for Play {
