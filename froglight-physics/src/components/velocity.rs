...
#[cfg_attr(feature = "bevy", require(PreviousVelocity, super::Acceleration))]
#[cfg_attr(feature = "bevy", reflect(Debug, Default, Clone, PartialEq, Component))]
pub struct Velocity(pub Vec3);

/// The [`Velocity`] of the previous tick.
#[repr(transparent)]
#[derive(Debug, Default, Clone, Copy, PartialEq)]
#[cfg_attr(feature = "bevy", derive(Component, Reflect))]
#[cfg_attr(feature = "bevy", require(super::PreviousAcceleration))]
#[cfg_attr(feature = "bevy", reflect(Debug, Default, Clone, PartialEq, Component))]
...
impls!(Velocity, PreviousVelocity);
