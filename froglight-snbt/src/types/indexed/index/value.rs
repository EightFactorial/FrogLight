...
use crate::types::indexed::index::Index;
// use crate::types::indexed::entry::{IndexedListType, IndexedMapType},
...
pub enum ValueIndex {
    ...
    String(Index<str>),
    /// A list of values.
    List(Index<()>), // List(Index<IndexedListType>),
    /// A compound of named entries.
    Compound(Index<()>), // Compound(Index<IndexedMapType>),
    /// A [`u32`] array.
    IntArray(Index<[u32]>),
    /// A [`u64`] array.
    LongArray(Index<[u64]>),
...
impl ValueIndex {
    ...
    #[inline]
    #[must_use]
    #[expect(clippy::match_same_arms, reason = "Temporarily")]
